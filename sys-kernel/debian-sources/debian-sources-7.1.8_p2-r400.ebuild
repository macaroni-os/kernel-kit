...
MACARONI_KSUFFIX="debian2-mark"
REVISION_SUFFIX="-forky"
EXTRAVERSION="-forky-debian2-mark"
LINUX_SRCDIR="linux-7.1.8-forky-debian2-mark"
MOD_DIR_NAME="7.1.8-forky-debian2-mark"
inherit check-reqs eutils ego savedconfig

DESCRIPTION="Debian Sources (and optional binary kernel)"
HOMEPAGE="https://packages.debian.org/unstable/kernel/"
SRC_URI="
https://deb.debian.org/debian/pool/main/l/linux/linux_7.1.8-2.debian.tar.xz -> linux_7.1.8-2.debian.tar.xz
