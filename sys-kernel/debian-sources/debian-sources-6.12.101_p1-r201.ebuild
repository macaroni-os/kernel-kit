...
EAPI=7
KERNEL_TRIPLET="6.12.101"
MACARONI_KTYPE="debian"
MACARONI_KSUFFIX="debian1-mark"
REVISION_SUFFIX="-trixie"
EXTRAVERSION="-trixie-debian1-mark"
LINUX_SRCDIR="linux-6.12.101-trixie-debian1-mark"
MOD_DIR_NAME="6.12.101-trixie-debian1-mark"
inherit check-reqs eutils ego savedconfig

DESCRIPTION="Debian Sources (and optional binary kernel)"
HOMEPAGE="https://packages.debian.org/unstable/kernel/"
SRC_URI="
https://deb.debian.org/debian/pool/main/l/linux/linux_6.12.101-1.debian.tar.xz -> linux_6.12.101-1.debian.tar.xz
https://mirrors.edge.kernel.org/pub/linux/kernel/v6.x/linux-6.12.101.tar.xz -> linux-6.12.101.tar.xz"
LICENSE="GPL-2"
SLOT="trixie/6.12.101_p1"
KEYWORDS="*"
...
# patches common to all kernel versions
	...
	if use custom-cflags; then
		eapply "${FILESDIR}/6.1.79+/more-ISA-levels-and-uarches-for-kernel-6.1.79+.patch" || die "use-patch 6.1.79+/more-ISA-levels-and-uarches-for-kernel-6.1.79+.patch failed"
	fi
