...
EAPI=7
KERNEL_TRIPLET="7.2.6"
MACARONI_KTYPE="debian"
MACARONI_KSUFFIX="debian1-mark"
REVISION_SUFFIX="-sid"
EXTRAVERSION="-sid-debian1-mark"
LINUX_SRCDIR="linux-7.2.6-sid-debian1-mark"
MOD_DIR_NAME="7.2.6-sid-debian1-mark"
inherit check-reqs eutils ego savedconfig

DESCRIPTION="Debian Sources (and optional binary kernel)"
HOMEPAGE="https://packages.debian.org/unstable/kernel/"
SRC_URI="
https://deb.debian.org/debian/pool/main/l/linux/linux_7.2.6-1.debian.tar.xz -> linux_7.2.6-1.debian.tar.xz
https://mirrors.edge.kernel.org/pub/linux/kernel/v7.x/linux-7.2.6.tar.xz -> linux-7.2.6.tar.xz"
LICENSE="GPL-2"
SLOT="sid/7.2.6_p1"
KEYWORDS="*"
